...
public class Application {
	...
	//	System.out.println("The premium amount for " + client2.getPolicyHolderName()+ " is " + premiumAmount); 
		...
		System.out.println("New vehicle cost is "+ vehicle1.vehicleCost() );
		System.out.println("New vehicle cost is "+ vehicle2.vehicleCost() );
		System.out.println("New vehicle cost is "+ vehicle3.vehicleCost() );
		System.out.println("New vehicle cost is "+ vehicle4.vehicleCost() );
